...
<head>
    ...
    <title>Notification 9 - Responsive Email Template</title><!-- Responsive Styles and Valid Styles -->
...
<span style="color: #1c2029;">Thankyou for showing interest in ${product}.</span> We will get back to you soon, please click the following button for find more information about this product:
										</div>
			        				</td>
								</tr>
							</table>
							...
							<table border="0" align="center" width="220" cellpadding="0" cellspacing="0" bgcolor="2fbbc8" style="margin: 5px 0px 15px 0px; border-radius: 50px; box-shadow: 0 1px 2px rgba(0,0,0,.3);" class="cta-button main_color">
								...
								<tr>
	                				...
	                				<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Varela Round', sans-serif;" class="cta-text">
		                    			...
		                    			<div style=" line-height: 24px;">
			                    			<a href=${link} style="font-size: 17px; color: #ffffff; text-decoration: none;">More About Product</a>
		                    			</div>
